...
export default function GlobalState({children}){
   ...
   return <GlobalContext.Provider value={{searchParam, loading, recipeList, setSearchParam, recipeDetailsData, setRecipeDetailsData, handleSubmit}}>{children}</GlobalContext.Provider>;
}
